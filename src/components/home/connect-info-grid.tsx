                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
                    ...
                    <div className="md:col-span-1 lg:col-span-1">
                        <Tilt
                            ...
                            className="h-full"
                        >
                            <div className="h-full p-8 rounded-[2rem] bg-[#171717]/80 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all flex flex-col justify-between group overflow-hidden relative">
                                ...
                                <div className="mt-8 relative z-10 w-full aspect-square bg-neutral-900/50 rounded-2xl border border-white/5 flex items-center justify-center">
                                    <div className="absolute w-2 h-2 bg-blue-500 rounded-full animate-ping" />
                                    <div className="w-2 h-2 bg-blue-500 rounded-full" />
                                    <div className="opacity-20 text-[10px] text-white">MAP_VISUALIZATION</div>
                                </div>
                            </div>
                        </Tilt>
                    </div>
